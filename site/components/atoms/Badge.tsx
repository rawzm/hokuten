/**
 * components/atoms/Badge.tsx — mono uppercase 11px inside a hairline pill.
 *
 * Governed by design-skill reference 03 (Components → Badges: "mono uppercase
 * 11px in a hairline pill — EXCLUSIVE · OFF-MARKET · IN CONTRACT · CLOSED, accent
...
export function Badge({
  ...
  return (
    <Tag
      className={cn(
        "hairline inline-flex items-center whitespace-nowrap rounded-pill px-3 py-1",
